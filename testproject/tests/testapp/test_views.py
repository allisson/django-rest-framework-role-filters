...
def test_get_allowed_actions(
    post1, post2, user_with_admin_role, user_with_user_role, client_admin_logged, client_user_logged
):
...
def test_deprecated_get_allowed_actions(post4, user_with_deprecated_role_in_view, client_user_logged):
